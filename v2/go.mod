...
require (
	...
	github.com/glauth/ldap v0.0.0-20240324000353-53c26f3f5ed3
...
replace github.com/glauth/ldap => github.com/shipperizer/ldap v0.0.0-20240325135818-8d923d778271
